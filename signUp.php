...
<body>
  ...
  <main class="signUp-bg">
    ...
    if (isset($_SESSION['message'])) {
      echo "<p class='font-Poppins success'>" . $_SESSION['message'] . "</p>";
    ...
    ?>
      <form action="./register.php" method="POST" class="signIn-form" enctype="multipart/form-data">
        ...
        <div>
          <label class="c-white1 font-Poppins" for="email">E-mail: </label>
        ...
        <div>
          <label class="c-white1 font-Poppins" for="avatar">Avatar: </label>
